    ...
    <>
      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          {page === "home" && <HomePage currentUser={currentUser} setPage={setPage} lakes={lakes} setLakes={setLakes} selectedLake={selectedLake} setSelectedLake={setSelectedLake} detailLake={detailLake} setDetailLake={setDetailLake} />}
